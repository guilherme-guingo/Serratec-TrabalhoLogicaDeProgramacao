# Serratec-TrabalhoLogicaDeProgramacao

Trabalho final da matéria lógica de programação da residência do Serratec, realizado em grupo por:

* GABRIEL MARTINS CHINELLI MAIA  
* GUILHERME FERNANDES GUINGO  
* HENRIQUE DLUGOKENSKI ZORATI  
* JHONATA ESTEVES RAIBOLT  
* LILIANE COSTA DA SILVA  
* LUIZ FELIPE VIEIRA DE OLIVEIRA RIBEIRO  

Cada integrante do grupo ficará responsável por 3 das 18 questões listadas abaixo.  
Para minimizar os erros do nosso projeto, decidimos seguir um padrão de mercado de forma que cada desenvolvedor criará a própria branch e o seu código precisará passar por um review de outro colega antes de mesclar com a main.
...
- [x] **Questão 3 - Separar números pares e ímpares de um vetor**
...
- [x] **Questão 9 - Sequência de Fibonacci até N termos**
